 ...
 * @return bool|null
 */
if ( ! function_exists( 'lfb_companion_admin_notice' ) ){
function lfb_companion_admin_notice(){
  global $current_user;
...
add_action( 'admin_notices', 'lfb_companion_admin_notice' );

add_action( 'admin_init', 'lfb_companion_notice_ignore' );
if ( ! function_exists( 'lfb_companion_notice_ignore' ) ){
function lfb_companion_notice_ignore(){
  global $current_user;
  $theme_data  = wp_get_theme();
  $user_id   = $current_user->ID;
...
if ( ! function_exists( 'lfb_companion_notice_scripts' ) ){
function lfb_companion_notice_scripts(){  
            wp_enqueue_style('hunk-companion-notices', LFB_PLUGIN_URL.'notify/assets/css/notice.css');
        }
}
add_action('admin_enqueue_scripts', 'lfb_companion_notice_scripts');